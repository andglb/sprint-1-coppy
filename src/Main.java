...
public class Main {
    public static void main(String[] args) {
        int months = 12;
        int days = 30;
        int[][] stepsInDay=new int[months][days];
        int mission=10000;
        ...
        while (true) {
            ...
            if (command == 1) {
                ...
                System.out.println("За месяц сожжено - "+converter.printCalories(printMonth, stepTracker.printMaxSteps(printMonth))+" килокалорий");
